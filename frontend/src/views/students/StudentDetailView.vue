      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex items-center">
            <router-link to="/students" class="inline-flex items-center text-orange-600 dark:text-orange-400 hover:text-orange-900 dark:hover:text-orange-300 mr-4">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
              </svg>
              Students
            </router-link>
            <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Student Details</h1>
          </div>
    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div class="px-4 py-6 sm:px-0">
        ...
        <div v-else-if="student" class="space-y-6">
          ...
          <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
              <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-4">Student Information</h3>
              <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Full Name</dt>
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ student.first_name }} {{ student.middle_name }} {{ student.last_name }}</dd>
                </div>
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Student ID</dt>
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ student.student_unique_id }}</dd>
                </div>
                <div class="sm:col-span-1">
                ...
                <div class="sm:col-span-1">
                  ...
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ student.contact_number || 'N/A' }}</dd>
                </div>
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Program</dt>
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ student.program }}</dd>
                </div>
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Year Level</dt>
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ student.year_level }}</dd>
                </div>
                <div class="sm:col-span-1">
                ...
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Academic Status</dt>
                  <dd class="mt-1">
                    <span :class="[
                      'inline-flex px-2 py-1 text-xs font-semibold rounded-full',
                      student.academic_status === 'Regular' ? 'bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200' :
                      student.academic_status === 'Probation' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' :
                      student.academic_status === 'Suspended' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' :
                ...
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">At Risk Status</dt>
                  <dd class="mt-1">
                    <span v-if="student.is_at_risk" class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200">
                      ⚠️ At Risk
                    </span>
                    <span v-else class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                      ✅ Normal
                    </span>
                  </dd>
                </div>
        ...
        <div v-else-if="error" class="text-center py-12">
          <div class="text-red-600 dark:text-red-400 text-lg font-semibold mb-4">Error loading student data</div>

    ...
    return [
      {
        ...
        content: 'The CCS-ISPS system will undergo scheduled maintenance on Sunday from 2 AM to 6 AM. Please save your work and log out before this time.',
        type: 'System',
        priority: 'high',
        status: 'published',
        target_type: 'all',
        user_id: 1,
        user: { id: 1, name: 'System Administrator', email: 'admin@ccs.edu.ph', role: 'admin' },
        image_url: '/src/views/announcements/images/placeholder-announcement.JPG',
      ...
      },
      {
        ...
        content: 'Join us for a comprehensive faculty development workshop on "Advanced Teaching Methodologies in Computer Science" scheduled for next Friday at the CCS Conference Room.',
        type: 'Faculty',
        priority: 'medium',
        status: 'published',
        target_type: 'professors',
        user_id: 2,
        user: { id: 2, name: 'Dr. Maria Santos', email: 'faculty@ccs.edu.ph', role: 'professor' },
        image_url: '/src/views/announcements/images/placeholder-announcement.JPG',
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      },
      {
        ...
        content: 'Call for papers for the annual CCS Research Symposium. Submit your research proposals by the end of this month. Open to all faculty and senior students.',
        type: 'Academic',
        priority: 'medium',
        status: 'published',
        target_type: 'all',
      ...
      },
      {
        ...
        content: 'The CCS Department has acquired new high-performance computing equipment for the Advanced Programming Laboratory. Faculty can now book the lab for practical sessions.',
        type: 'Facilities',
        priority: 'low',
        status: 'published',
        target_type: 'professors',
      ...
      },
      {
        ...
        content: 'Multiple IT companies are offering internship opportunities for CCS students. Check the career portal for application deadlines and requirements.',
        type: 'Student',
        priority: 'medium',
        status: 'published',
